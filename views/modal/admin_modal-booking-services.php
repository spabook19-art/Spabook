      ...
      <div class="card service-card pending mb-3">
        <div class="card-body">
          ...
          <div class="therapist-notes-section mt-3">
            ...
            <textarea class="form-control therapist-notes" rows="3"
              placeholder="Enter notes about this service session..."></textarea>
          </div>
        </div>
      </div>
        ...
        <div class="card-body">
          <div class="row align-items-start">
            <div class="col-md-8">
              <div class="d-flex align-items-center mb-2">
                <i class="bi bi-clock text-warning me-2 fs-5"></i>
                <h6 class="mb-0 fw-bold">Special Treatment for Stroke</h6>
                <span class="badge bg-info ms-2">Stroke Treatment</span>
              </div>
              <p class="text-muted mb-2 small">Therapy focused on stroke recovery</p>
              <div class="d-flex align-items-center">
                <span class="badge bg-light text-dark me-2">
                  <i class="bi bi-clock me-1"></i> 90 min
                </span>
                <span class="badge bg-light text-dark me-2">
                  <i class="bi bi-currency-dollar me-1"></i> ₱1000
                </span>
                <span class="badge bg-light text-dark">
                  <i class="bi bi-calendar me-1"></i> 10/02/2025
                </span>
              </div>
            </div>
            <div class="col-md-4 text-md-end">
          ...
          <div class="stroke-progress-container mt-3">
